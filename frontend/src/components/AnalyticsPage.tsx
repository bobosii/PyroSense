...
function MetricBar({ value, color }: { value: number | null; color: string }) {
    if (value === null) return (
        <span style={{ fontFamily: "var(--font-data)", fontSize: 12, color: "var(--text-dim)" }}>—</span>
    );
...
/* ── StatCard ── */
function StatCard({
    title, subtitle, children, accent, icon,
}: {
    title: string;
    subtitle: string;
                        ...
                        <button
                            ...
                            onMouseEnter={(e) => {
                                if (!loading) {
                                    ...
                                    (e.target as HTMLButtonElement).style.borderColor = "var(--border-hi)";
                                    (e.target as HTMLButtonElement).style.color = "var(--text)";
                                }
                            }}
                            onMouseLeave={(e) => {
                                (e.target as HTMLButtonElement).style.background = "var(--bg-card)";
                                (e.target as HTMLButtonElement).style.borderColor = "var(--border-mid)";
                    ...
                    <>
                        ...
                        <div style={{
                            ...
                            >
                                <StatRow
                                    ...
                                    value={metrics.dangerDetection.truePositive.toLocaleString("tr-TR")}
                                />
                                <StatRow
                                    label="Yanlış Negatif (FN)"
                                    value={metrics.dangerDetection.falseNegative.toLocaleString("tr-TR")}
                                />
                            ...
                            >
                                <StatRow
                                    ...
                                    value={metrics.normalConditions.trueNegative.toLocaleString("tr-TR")}
                                />
                                <StatRow
                                    label="Yanlış Pozitif (FP)"
                                    value={metrics.normalConditions.falsePositive.toLocaleString("tr-TR")}
                                />
                                <div style={{ paddingTop: 10 }}>
                                    <div style={{
                                        fontFamily: "var(--font-label)",
                            ...
                            >
                                <StatRow
                                    label="Yanlış Alarm"
                                    value={metrics.sensorFault.falseAlarms.toLocaleString("tr-TR")}
                                />
                                <StatRow
                                    label="Doğru Bastırılan"
                                    value={metrics.sensorFault.correctlySuppressed.toLocaleString("tr-TR")}
                                />
                                    ...
                                    <div style={{ paddingTop: 10 }}>
                                        ...
                                        <MetricBar
                                            value={
                                                ...
                                                (metrics.sensorFault.falseAlarms + metrics.sensorFault.correctlySuppressed)
                                            }
                                            color="var(--secondary)"
                                        />
                                    </div>
                        ...
                        <div style={{
                            ...
                            <p style={{
                                ...
                                Ontoloji motoru bu etiketlere bakmaz — yalnızca ham sensör değerleri üzerinde SPARQL çıkarımı yapar.
                                Bu tablo ikisinin örtüşme oranını gösterir.
                            </p>
                        </div>
